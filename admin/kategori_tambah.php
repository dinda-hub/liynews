...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama)) {
        ...
        $cek = mysqli_query($koneksi, "SELECT id_kategori FROM kategori WHERE nama_kategori='$nama'");
        if (mysqli_num_rows($cek) > 0) {
            $error = "Nama kategori sudah ada.";
        } else {
            mysqli_query($koneksi, "INSERT INTO kategori (nama_kategori, deskripsi) VALUES ('$nama', '$deskripsi')");
            header("Location: kategori.php?msg=tambah"); exit;
        }
    }
}
?>
...
<head>
  ...
  <title>Tambah Kategori — LiyNews Admin</title>
...
<div class="content">
  ...
  <div class="page-hd">
    <div>
      ...
      <h1 class="page-title">Tambah <em>Kategori</em></h1>
      <p class="page-sub">Isi form di bawah untuk menambah kategori berita baru.</p>
    </div>
    ...
    <form method="POST" novalidate>
      <div class="tcard">
        <div class="card-section">
          ...
          <div class="field">
            <label for="deskripsi">Deskripsi <span style="color:var(--faint);font-weight:400;text-transform:none;letter-spacing:0">(opsional)</span></label>
